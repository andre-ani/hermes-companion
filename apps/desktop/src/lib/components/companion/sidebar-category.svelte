...
<style>
  ...
  .category-title { overflow: hidden; font-family: var(--font-ui); font-size: var(--type-small); font-weight: 560; letter-spacing: 0; text-overflow: ellipsis; white-space: nowrap; }
  .category-count { flex: none; color: var(--muted-foreground); font-family: var(--font-mono); font-size: var(--type-caption); font-variant-numeric: tabular-nums; }
